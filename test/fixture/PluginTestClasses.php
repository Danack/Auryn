...
class AuthenticatedStatus implements AuthenticationStatus {

}
class UnauthenticatedStatus implements AuthenticationStatus {
...
class TestProviderPlugin extends \Auryn\Plugin\StandardProviderPlugin {
    ...
    function getAlias($className, array $classConstructorChain) {
        ...
        return parent::getAlias($className, $classConstructorChain);
    }
}
