...
class PluginTest extends PHPUnit_Framework_TestCase {
    ...
    public function testClassConstructorChainDefine1() {
        ...
        $providerPlugin->define('WidgetWithParams', array(':name' => 'parent2'), array('UsesWidgetWithParams2'));
    ...
    public function testUnableToFindDefine() {
        ...
        //$declaringClass,$param->name
        $this->setExpectedException(
            'Auryn\\InjectionException',
            sprintf(\Auryn\Provider::$errorMessages[
            \Auryn\Provider::E_UNDEFINED_PARAM], 'WidgetWithParams', 'name'),
            Provider::E_UNDEFINED_PARAM
        );
    ...
    public function testClassConstructorChainSharingNotFound() {
        ...
        $providerPlugin->shareInstance($warningLogger, array('RequiresLogger1'));
    ...
    public function testClassConstructorChainSharing1() {
        ...
        $providerPlugin->shareInstance($warningLogger, array('RequiresLogger1'));
        $providerPlugin->shareInstance($infoLogger, array('RequiresLogger2'));
    ...
    public function testClassConstructorChainSharing2() {
        ...
        $providerPlugin->shareInstance($warningLogger); //Used by all classes
    ...
    public function testClassConstructorChainSharing3() {
        ...
        $providerPlugin->shareInstance($warningLogger); //Used by all classes
        $providerPlugin->shareInstance($infoLogger, array('RequiresLogger2')); //used by RequiresLogger2 and it's constructor dependencies.
